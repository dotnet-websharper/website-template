var wsbundle=(()=>{var dr=Object.defineProperty;var jo=Object.getOwnPropertyDescriptor;var Uo=Object.getOwnPropertyNames;var Oo=Object.prototype.hasOwnProperty;var qo=(e,t)=>{for(var r in t)dr(e,r,{get:t[r],enumerable:!0})},Ho=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Uo(t))!Oo.call(e,o)&&o!==r&&dr(e,o,{get:()=>t[o],enumerable:!(n=jo(t,o))||n.enumerable});return e};var Ko=e=>Ho(dr({},"__esModule",{value:!0}),e);var Sc={};qo(Sc,{Layout:()=>Jo,Runtime:()=>hn,Support:()=>Zo});function ot(e,t){return Object.assign(Object.create(e.prototype),t)}var Yo=Symbol("force");function K(e){var t;function r(){return t||(t=e(o=>t=o)),t}return new Proxy(function(){},{get(o,a){return a==Yo&&r(),r()[a]},set(o,a,i){return r()[a]=i,!0},construct(o,a,i){return Reflect.construct(r(),a,i)}})}function cn(e,t){for(var r=0;r<t.length;r++){var n=t[r];e[n]===void 0&&delete e[n]}return e}function It(e){return e===void 0?null:{$:1,$0:e}}function qt(e,t,r){r?e[t]=r.$0:delete e[t]}function dn(e){return function(...t){return e(t)}}function un(e){return Object.defineProperty(e,"resizable",{enumerable:!1,writable:!1,configurable:!1,value:!0}),e}var pn=globalThis.WebSharperRuntime||{ScriptBasePath:"./",ScriptSkipAssemblyDir:!1};globalThis.WebSharperRuntime=pn;var hn=pn;document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelectorAll(".section-link"),t=document.querySelectorAll(".section"),r={root:null,threshold:1,rootMargin:"0px"};function n(a){a.classList.add("active-link")}let o=new IntersectionObserver(function(a){a.forEach(i=>{i.isIntersecting&&e.forEach(l=>{let s=l.getAttribute("data-step"),d=i.target.getAttribute("id");s===d?n(l):l.classList.remove("active-link")})})},r);t.forEach(a=>{o.observe(a)})});document.addEventListener("DOMContentLoaded",()=>{let e=document.getElementById("track"),t=document.getElementById("mini-inner"),r=document.getElementById("mini-prev"),n=document.getElementById("mini-next");if(!e||!t||!r||!n)return;let o=Array.from(t.children);if(o.length===0)return;let a=o[0].cloneNode(!0),i=o[o.length-1].cloneNode(!0);t.insertBefore(i,o[0]),t.appendChild(a);let l=1,s=!1,d=null,u=!1,m=N=>{t.style.transition=N?"transform 0.7s ease-out":"none",t.style.transform=`translateX(-${l*100}%)`},w=()=>{u||(u=!0,l+=1,m(!0))},f=()=>{u||(u=!0,l-=1,m(!0))};t.addEventListener("transitionend",()=>{let N=t.children.length,C=N-2;l===N-1?(l=1,m(!1)):l===0&&(l=C,m(!1)),requestAnimationFrame(()=>{u=!1})}),n.addEventListener("click",w),r.addEventListener("click",f);let k=()=>{$(),d=setInterval(()=>{s||w()},5e3)},$=()=>{d&&clearInterval(d)};e.addEventListener("mouseenter",()=>{s=!0}),e.addEventListener("mouseleave",()=>{s=!1}),m(!1),k()});function et(e){return"Dispose"in e}function Jo(){ta();let e=bn(),t=mn(),r=fn(),n=vn(),o=bn(),a=mn(),i=fn(),l=vn(),s=wa(),d=ga(),u=wn(),m=wn(),w=ha(),f=pa(),k=new St("New_1"),$=(k.h.push(tt(k.k,"togglemenu",()=>k.i,()=>{Qo()})),k),N=($.h.push(tt($.k,"toggletheme",()=>$.i,()=>{ea()})),$),C=(N.h.push(tt(N.k,"onkeydown",()=>N.i,nt=>{la(nt)})),N),v=(C.h.push(tt(C.k,"onstoppropagation",()=>C.i,nt=>{sa(nt)})),C),c=(v.h.push(tt(v.k,"closeonbackgroundclick",()=>v.i,nt=>{ca(nt)})),v),h=(c.h.push(tt(c.k,"accountbtnclick",()=>c.i,nt=>{da(nt)})),c),x=(h.h.push(tt(h.k,"accountbtnkeydown",()=>h.i,()=>{})),h),b=(x.h.push(tt(x.k,"login",()=>x.i,()=>{ma()})),x),p=(b.h.push(tt(b.k,"logout",()=>b.i,nt=>{ua(nt)})),b),y=(p.h.push(new B("dropdownattr",f)),p),M=(y.h.push(new B("accountbtnaria",w)),y),E=(M.h.push(new B("avatarattr",m)),M),D=(E.h.push(new B("avatarattrhamburger",u)),E),V=(D.h.push(new B("iconattr",d)),D),P=(V.h.push(new B("skeletonattr",s)),V),J=(P.h.push(new At("accountheadertext",ia())),P),G=(J.h.push(new B("headerattrd",l)),J),U=(G.h.push(new B("btnmanageattrd",i)),G),Z=(U.h.push(new B("btnloginattrd",a)),U),ut=(Z.h.push(new B("btnlogoutattrd",o)),Z),Mt=(ut.h.push(new B("headerattr",n)),ut),Ve=(Mt.h.push(new B("btnmanageattr",r)),Mt),de=(Ve.h.push(new B("btnloginattr",t)),Ve),Ct=(de.h.push(new B("btnlogoutattr",e)),de),Ot=Ht(Ct.k,Ct.h,[]);return Ct.i=new bt(Ot[1],ho(Ot[0])),va(),st.Empty}function Zo(){return Aa()}function Qo(){let e=ur("navmenu"),t=ur("openIcon"),r=ur("closeIcon"),n=globalThis.document.body;e.classList.toggle("h-screen"),t.classList.toggle("hidden-open-icon"),r.classList.toggle("visible-close-icon"),n.classList.toggle("overflow-hidden")}function Xo(e){let t=[],r;for(var n in e)t.push(e[n]);return t}function ta(){zn();let e=globalThis.localStorage.getItem("color-theme");e=="dark"||e==null&&ra()?mr(!0):mr(!1)}function ea(){na(Bn()=="dark"?"light":"dark")}function zn(){let e=Bn(),t=globalThis.document.querySelectorAll(".themed-iframe");for(let r=0,n=oa(t.length)-1;r<=n;r++){let o=t[r],a=o.getAttribute("data-src");if(a!=null){let i=new URL(a,globalThis.location.href);i.searchParams.set("theme",e),o.setAttribute("src",String(i))}}}function ra(){return globalThis.matchMedia("(prefers-color-scheme: dark)").matches}function mr(e){e?br().classList.add("dark"):br().classList.remove("dark")}function na(e){mr(e=="dark"),globalThis.localStorage.setItem("color-theme",e),zn()}function Bn(){return br().classList.contains("dark")?"dark":"light"}function br(){return globalThis.document.documentElement}function S(e,t){return Pn(e,t),e[t]}function I(e){return e.dims===2?e.length*e.length:e.length}function Pn(e,t){(t<0||t>=e.length)&&W("Index was outside the bounds of the array.")}function Or(e,t,r){Pn(e,t),e[t]=r}function oa(e){let t=aa(e);return t>2147483647?t-4294967296:t}function W(e){throw new Error(e)}function aa(e){return(e<0?Math.ceil(e):Math.floor(e))>>>0}function Dt(e){return[e.K,e.V]}function gn(e,t){let r=1+t-e;return r<=0?[]:xl(r,n=>n+e)}var j=class{Equals(t){return this===t}GetHashCode(){return-1}},St=class extends j{i;k;h;s;constructor(t){if(t=="New_1"){let r;super(),this.i=null,this.k=(r=Va(),String(r)),this.h=un([]),qt(this,"s",null)}}};function ia(){return kt.AccountHeaderText}function la(e){e.Event.key=="Escape"&&_t().Set(!1)}function sa(e){e.Event.stopPropagation()}function ca(){_t().Get()&&_t().Set(!1)}function da(){_t().Set(!_t().Get())}function ua(){Xe(z(()=>(_t().Set(!1),R(xa(!0),()=>O(null)))),null)}function pa(){return Nt("hidden",_(e=>!e,_t().View))}function ha(){return at("aria-expanded",_(e=>e?"true":"false",_t().View))}function wn(){return Q.Concat([at("src",Rn()),Nt("hidden",_(e=>!e,Wn())),Nt("opacity-0",pe().View)])}function ga(){return Q.Concat([Nt("hidden",Wn()),Nt("opacity-0",pe().View)])}function wa(){return Nt("opacity-0 hidden",_(e=>!e,pe().View))}function vn(){return Je(Ze())}function fn(){return Je(Ze())}function mn(){return Je(_(e=>!e,Ze()))}function bn(){return Je(Ze())}function va(){Xe(z(()=>(pe().Set(!0),R(ya(),()=>R(fi(500),()=>(pe().Set(!1),it()))))),null)}function _t(){return kt.isOpen}function Rn(){return kt.avatarSrcV}function Wn(){return kt.hasAvatarV}function pe(){return kt.isLoading}function Je(e){return Q.Concat([Nt("hidden",_(t=>!t,e)),Nt("flex",e)])}function Ze(){return kt.isAuthedV}function xn(){return kt.userV}function fa(){return kt.displayNameV}function tt(e,t,r,n){return new De(t,"",o=>a=>{let i=r();return i.SetAnchorRoot(o),n({Vars:i,Anchors:i,Target:o,Event:a})})}function Ht(e,t,r){let n=new rt("New_5"),o=new ct("New_3"),a=L(t);try{for(;a.MoveNext();){let i=a.Current,l=i.Name;o.SAdd(l),n.set_Item(l,i)}}finally{let i=a;typeof i=="object"&&et(i)&&a.Dispose()}return[so(t,Qr(i=>{let l=i[0],s=i[1],d=i[2];if(o.Contains(l))return null;{let u=s===0?Y.GetOrAddHoleFor(e,l,()=>{let m=d==null?null:g(d.$0),w=m==null?"":m.$0,f=T.Create_1(w);return new wt(l,f)}):s===1?Y.GetOrAddHoleFor(e,l,()=>{let m=d==null?null:g(d.$0),w=m==null?0:m.$0,f=T.Create_1(w);return new je(l,f)}):s===2?Y.GetOrAddHoleFor(e,l,()=>{let m=d==null?null:g(d.$0),w=m==null?!1:m.$0,f=T.Create_1(w);return new Ue(l,f)}):s===3?Y.GetOrAddHoleFor(e,l,()=>{let m=d==null?null:g(d.$0),w=m==null?-864e13:m.$0,f=T.Create_1(w);return new Oe(l,f)}):s===4?Y.GetOrAddHoleFor(e,l,()=>new qe(l,T.Create_1([]))):s===5?Y.GetOrAddHoleFor(e,l,()=>new ve(l,T.Create_1(g(globalThis.document.querySelector("[ws-dom="+l+"]"))))):s===6?Y.GetOrAddHoleFor(e,l,()=>{let m=d==null?null:g(d.$0),w=m==null?[]:m.$0,f=T.Create_1(w);return new He(l,f)}):W("Invalid kind for template Var type: "+String(s));return n.set_Item(l,u),g(u)}},r)),{$:0,$0:n}]}function ma(){globalThis.location.href=ba()}function ba(){return $a(globalThis.location.pathname+globalThis.location.search)}function xa(e){return z(()=>bi(we(z(()=>R(Ci(),()=>O(null))),t=>(console.error("AuthClient.Logout RPC failed",t),it())),z(()=>(Kt().Set(null),e?we(z(()=>(globalThis.location.reload(),it())),()=>it()):it()))))}function ya(){return z(()=>{let e=Kt().Get();return e!=null&&e.$==1?O(g(e.$0)):(xr().Set(!0),Hr(z(()=>we(z(()=>R($i(),t=>(Kt().Set(t),O(t)))),t=>(console.error("AuthClient.FetchMe RPC failed",t),Kt().Set(null),O(null)))),()=>{xr().Set(!1)}))})}function ka(){return _e.UserView}function Ca(){return _e.IsAuthedView}function $a(e){return"https://api.websharper.io/auth/github/start?returnUrl="+encodeURIComponent(e)}function Kt(){return _e.userVar}function xr(){return _e.isFetchingVar}var st=class e extends j{docNode;updates;static get Empty(){return e.Mk(null,ge())}static Mk(t,r){return new e(t,r)}static RunBefore(t,r){let n=globalThis.document.createTextNode("");t.parentNode.insertBefore(n,t),e.RunBetween(n,t,r)}static EmbedView(t){let r=bs();return e.Mk(il(r),_(()=>{},Wa(n=>(xs(r,n.docNode),n.updates),t)))}static RunBetween(t,r,n){rn(r,n.docNode);let o=ys(t,r,n.docNode);Ge(Mr()||Ir()?Dn(Vn(!1,o,n.docNode)):()=>{Mn(!1,o,n.docNode)},n.updates)}static RunInPlace(t,r,n){let o=ks(r,n.docNode);Ge(Mr()||Ir()?Dn(Vn(t,o,n.docNode)):()=>{Mn(t,o,n.docNode)},n.updates)}static TextNode(t){return e.Mk(ll(globalThis.document.createTextNode(t)),ge())}static TextView(t){let r=Es();return e.Mk(sl(r),_(n=>{Vs(r,n)},t))}ReplaceInDom(t){let r=globalThis.document.createTextNode("");t.parentNode.replaceChild(r,t),e.RunBefore(r,this)}constructor(t,r){super(),this.docNode=t,this.updates=r}};function Aa(){let e=Ka(),t=Ha(),r=$n("freelancer"),n=$n("pro"),o=new St("New_1"),a=(o.h.push(new We("onafterrender","",()=>{Xe(ri(),null)})),o),i=(a.h.push(new Zt("proplan",n)),a),l=(i.h.push(new Zt("freelancerplan",r)),i),s=(l.h.push(new B("billmonthattr",t)),l),d=(s.h.push(new B("billyearattr",e)),s),u=(d.h.push(tt(d.k,"onbillmonth",()=>d.i,p=>{Ya(p)})),d),m=(u.h.push(tt(u.k,"onbillyear",()=>u.i,p=>{Ja(p)})),u),w=(m.h.push(new wt("contactsubjectvar",T.Lens($t(),p=>p.subject,(p,y)=>Ft(y,p.message,p.email,p.name,p.country)))),m),f=(w.h.push(new wt("contactmessagevar",T.Lens($t(),p=>p.message,(p,y)=>Ft(p.subject,y,p.email,p.name,p.country)))),w),k=(f.h.push(new wt("contactemailvar",T.Lens($t(),p=>p.email,(p,y)=>Ft(p.subject,p.message,y,p.name,p.country)))),f),$=(k.h.push(new wt("contactnamevar",T.Lens($t(),p=>p.name,(p,y)=>Ft(p.subject,p.message,p.email,y,p.country)))),k),N=($.h.push(new wt("contactcountryvar",T.Lens($t(),p=>p.country,(p,y)=>Ft(p.subject,p.message,p.email,p.name,y)))),$),C=(N.h.push(new B("contactsendbuttonattr",qa())),N),v=(C.h.push(new At("contactsendbuttontext",Oa())),C),c=(v.h.push(tt(v.k,"oncontactsendclick",()=>v.i,p=>{Za(p)})),v),h=Ht(c.k,c.h,[["contactsubjectvar",0,g("WebSharper support")],["contactmessagevar",0,null],["contactemailvar",0,null],["contactnamevar",0,null],["contactcountryvar",0,g("United States")]]),x=new bt(h[1],di(h[0]));return(c.i=x,x).Doc}var bt=class extends j{doc;allVars;anchorRoot;SetAnchorRoot(t){this.anchorRoot=t}get Doc(){return this.doc}Hole(t){return this.allVars.Item(t)}constructor(t,r){super(),this.doc=r,this.allVars=t.$==0?t.$0:W("Should not happen"),this.anchorRoot=null}},H=class extends j{ForTextView(){return console.warn("Content hole filled with attribute data",this.Name),null}AddAttribute(t,r){console.warn("Var hole filled with non-Var data",this.Name)}get AsChoiceView(){return console.warn("Attribute value hole filled with non-text data",this.Name),ln("")}ApplyVarHole(t){console.warn("Not a var hole: ",this.Name)}},B=class e extends H{name;fillWith;get Name(){return this.name}get Value(){return this.fillWith}WithName(t){return new e(t,this.fillWith)}constructor(t,r){super(),this.name=t,this.fillWith=r}},At=class e extends H{name;fillWith;get Name(){return this.name}WithName(t){return new e(t,this.fillWith)}ForTextView(){return g(this.fillWith)}get AsChoiceView(){return Ut(this.fillWith)}constructor(t,r){super(),this.name=t,this.fillWith=r}},kt=K(e=>class{static{kt=e(this)}static AccountHeaderText;static displayNameV;static hasAvatarV;static avatarSrcV;static isLoading;static isAuthedV;static userV;static isOpen;static{this.isOpen=T.Create_1(!1),this.userV=ka(),this.isAuthedV=Ca(),this.isLoading=T.Create_1(!0),this.avatarSrcV=_(r=>r!=null&&r.$==1?Jt(r.$0.avatarUrl)?"":r.$0.avatarUrl:"",xn()),this.hasAvatarV=_(r=>r!="",Rn()),this.displayNameV=_(r=>r==null||Jt(r.$0.login)?"Account":r.$0.login,xn()),this.AccountHeaderText=fa()}});function A(e,t){if(e===t)return!0;{let o=typeof e;if(o=="object"){if(e==null||t===null||t===void 0||!A(typeof t,"object"))return!1;if("Equals"in e)return e.Equals(t);if("Equals"in t)return!1;if(e instanceof Array&&t instanceof Array)return yn(e,t);if(e instanceof Date&&t instanceof Date)return Sa(e,t);{let a=e,i=t,l=[!0],s;for(var r in a)if((d=>(l[0]=!a.hasOwnProperty(d)||i.hasOwnProperty(d)&&A(a[d],i[d]),!l[0]))(r))break;if(l[0]){let d;for(var n in i)if((u=>(l[0]=!i.hasOwnProperty(u)||a.hasOwnProperty(u),!l[0]))(n))break}return l[0]}}else return o=="function"&&("$Func"in e?e.$Func===t.$Func&&e.$Target===t.$Target:"$Invokes"in e&&"$Invokes"in t&&yn(e.$Invokes,t.$Invokes))}}function he(e){let t=typeof e;return t=="function"?0:t=="boolean"?e?1:0:t=="number"?e:t=="string"?Le(e):t=="object"?e==null?0:e instanceof Array?_a(e):Na(e):t=="bigint"?Le(String(e)):t=="symbol"?Le(e.description):0}function Pt(e,t){if(e===t)return 0;{let o=typeof e;switch(o=="boolean"||o=="number"||o=="bigint"||o=="string"?1:o=="object"?2:o=="function"?3:o=="symbol"?4:0){case 0:return typeof t>"u"?0:-1;case 1:return e<t?-1:1;case 2:if(e===null)return-1;if(t===null)return 1;if("CompareTo"in e)return e.CompareTo(t);if("CompareTo0"in e)return e.CompareTo0(t);if(e instanceof Array&&t instanceof Array)return Ta(e,t);if(e instanceof Date&&t instanceof Date)return Ea(e,t);{let a=e,i=t,l=[0],s;for(var r in a)if((d=>a.hasOwnProperty(d)?i.hasOwnProperty(d)?(l[0]=Pt(a[d],i[d]),l[0]!==0):(l[0]=1,!0):!1)(r))break;if(l[0]===0){let d;for(var n in i)if((u=>i.hasOwnProperty(u)?!a.hasOwnProperty(u)&&(l[0]=-1,!0):!1)(n))break}return l[0]}break;case 3:return W("Cannot compare function values.");case 4:return W("Cannot compare symbol values.")}}}function yn(e,t){let r,n;if(I(e)===I(t)){for(r=!0,n=0;r&&n<I(e);)A(S(e,n),S(t,n))||(r=!1),n=n+1;return r}else return!1}function Sa(e,t){return e.getTime()===t.getTime()}function Le(e){let t;if(e===null)return 0;t=5381;for(let r=0,n=e.length-1;r<=n;r++)t=qr(t,e[r].charCodeAt());return t}function _a(e){let t=-34948909;for(let r=0,n=I(e)-1;r<=n;r++)t=qr(t,he(S(e,r)));return t}function Na(e){if("GetHashCode"in e)return e.GetHashCode();{let r=qr,n=[0],o;for(var t in e)if((a=>(n[0]=r(r(n[0],Le(a)),he(e[a])),!1))(t))break;return n[0]}}function Ta(e,t){let r,n;if(I(e)<I(t))return-1;if(I(e)>I(t))return 1;for(r=0,n=0;r===0&&n<I(e);)r=Pt(S(e,n),S(t,n)),n=n+1;return r}function Ea(e,t){return Pt(e.getTime(),t.getTime())}function qr(e,t){return(e<<5)+e+t}function Va(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(new RegExp("[xy]","g"),e=>{let t=Math.random()*16|0;return(e=="x"?t:t&3|8).toString(16)})}var De=class e extends H{name;key;fillWith;get Name(){return this.name}get Value(){return this.fillWith}WithName(t){return new e(t,this.key,this.fillWith)}constructor(t,r,n){super(),this.name=t,this.key=r,this.fillWith=n}};function Ma(e){let t={},r=L(e);try{for(;r.MoveNext();){let n=r.Current;t[n[0]]=n[1]}}finally{let n=r;typeof n=="object"&&et(n)&&r.Dispose()}return t}function ur(e){return globalThis.document.getElementById(e)}function kn(e){return"\u20AC"+String(e)}var Fe=class extends j{};function Nt(e,t){return er(t,r=>n=>n?Ii(r,e):Li(r,e))}function at(e,t){return er(t,r=>n=>r.setAttribute(e,n))}function Ia(e,t){return er(t,r=>n=>n?r.setAttribute(e,""):r.removeAttribute(e))}function La(e,t){return Q.A3(r=>{r.addEventListener(e,n=>t(r)(n),!1)})}function Cn(e){return Q.A4(e)}function Da(e){return ee(So(),e)}function Fa(e){return ee(_o(),e)}function Ga(e){return ee(No(),e)}function za(e){return ee(To(),e)}function Ba(e){return ee(Eo(),e)}function Pa(e){return ee(Vo(),e)}function ee(e,t){let r=e(t);return Jn(Q.A3(r[0]),Ra(r[1],r[2]))}function Ra(e,t){return er(t,e)}function _(e,t){return re(()=>ne(e,t()))}function ge(e){let t={s:Et(e)};return()=>t}function re(e){let t={c:null,o:e};return()=>{let r=t.c;if(r===null){r=t.o(),t.c=r;let n=r.s;return n!=null&&n.$==0?t.o=null:eo(r,()=>{t.c=null}),r}else return r}}function Qe(e,t,r){return re(()=>rr(e,t(),r()))}function jn(e,t,r,n){return re(()=>qi(e,t(),r(),n()))}function Wa(e,t){return ja(_(e,t))}function Ge(e,t){function r(){Xi(t(),e,()=>{Tt().Fork(r)})}Tt().Fork(r)}function ja(e){return re(()=>tl(e()))}function Ua(e){return re(()=>el(Wt(t=>t(),e)))}function ze(e,t){return re(()=>rl(e(),t()))}var Q=class e{static Concat(t){let r=nr(t);return or(Kr(),(n,o)=>Jn(n,o),r)}static A1(t){return ot(e,{$:1,$0:t})}static A2(t,r){return ot(e,{$:2,$0:t,$1:r})}static HandlerImpl(t,r){return e.A3(n=>{n.addEventListener(t,o=>r(n)(o),!1)})}static Create(t,r){return e.A3(n=>{n.setAttribute(t,r)})}static A4(t){return ot(e,{$:4,$0:t})}static A3(t){return ot(e,{$:3,$0:t})}$;$0;$1};function Oa(){return Zr.ContactSendButtonText}function qa(){return Zr.ContactSendButtonAttr}function Ha(){let e=_(t=>t.$==1?"false":"true",mt().View);return Q.Concat([at("data-active",e),at("aria-pressed",e)])}function Ka(){let e=_(t=>t.$==1?"true":"false",mt().View);return Q.Concat([at("data-active",e),at("aria-pressed",e)])}function Ya(){mt().Set(gl)}function Ja(){mt().Set(lo)}function Za(e){e.Event.preventDefault();let t=$t().Get();On(t)?Xe(z(()=>(Be().Set(!0),Hr(z(()=>R(ai(t),r=>r?(alert("Message sent successfully!"),Qa(),it()):(alert("Failed to send message. Please try again later."),it()))),()=>{Be().Set(!1)}))),null):alert("Please fill in all required fields.")}function Qa(){$t().Set(Ft("WebSharper support","","","","United States"))}var T=K(e=>class extends j{static{T=e(this)}static Lens(r,n,o){let a=cl(),i=_(n,r.View);return new class extends Fe{constructor(){super()}Get(){return n(r.Get())}Set(l){return r.Update(s=>o(s,l))}SetFinal(l){return this.Set(l)}Update(l){return r.Update(s=>o(s,l(n(s))))}UpdateMaybe(l){return r.UpdateMaybe(s=>{let d=l(n(s));return d==null?null:g(o(s,d.$0))})}get View(){return i}get Id(){return a}}}static Create_1(r){return new Ar(!1,{s:ir(r,[])},r)}});function $t(){return Rt.ContactFormVar}function yr(){return Rt.IsLoadingVar}function Un(){return Rt.catalogVar}function mt(){return Rt.intervalVar}function On(e){return!Jt(e.message)&&!Jt(e.email)&&!Jt(e.name)&&ei(e.email)}function Be(){return Rt.IsSendingVar}function Xa(){return Rt.CanSendView}function pr(e){return e.$==1?"year":"month"}function ti(e){let n=Pt(999,e)===-1?999:e;return Pt(1,n)===1?1:n}function ei(e){if(e==null)return!1;{let t=Hl(e);return t.indexOf("@")!=-1&&t.indexOf(".")!=-1}}function Ft(e,t,r,n,o){return{subject:e,message:t,email:r,name:n,country:o}}function ri(){return z(()=>(yr().Set(!0),Hr(z(()=>R(ni(),e=>(e==null||oi(e.$0),it()))),()=>{yr().Set(!1)})))}function ni(){return z(()=>{let e=ii();return e==null?R(li(),t=>{let r;return t!=null&&t.$==1&&I(t.$0)>0&&(r=t.$0,!0)?(si(r),O(g(r))):O(null)}):O(g(e.$0))})}function oi(e){Un().Set(ao(dl(El(t=>{let r=t.YearPrice;return r!=null&&r.$==1?r.$0.Amount:0},dt(t=>{let r=t[1],n=S(r,0),o=l=>{let s=Tl(d=>d.interval==l,r);if(s==null)return null;{let d=s.$0,u=Xl(d.unitAmountCents/100,d.currency.toUpperCase());return g(u)}},a=n.description,i=a==null?"":a.$0;return hl(t[0],n.name,i,n.isPerSeat,n.maxSeats,o("month"),o("year"))},gs(t=>t.code.toLowerCase(),e))))))}function ai(e){return z(()=>{let t=new FormData;return t.append("subject",e.subject),t.append("message",e.message),t.append("email",e.email),t.append("name",e.name),t.append("country",e.country),we(z(()=>{let r;return R(ts(globalThis.fetch("https://api.intellifactory.com/api/contact",(r={},r.method="POST",r.body=t,r))),n=>O(n.ok))}),()=>O(!1))})}function ii(){try{let e=globalThis.sessionStorage.getItem("planprices");return e==null||Jt(e)?null:g(JSON.parse(e))}catch{return null}}function li(){return z(()=>we(z(()=>R(Ai(),e=>O(g(e)))),()=>O(null)))}function si(e){try{let t=JSON.stringify(e);globalThis.sessionStorage.setItem("planprices",t)}catch{}}function $n(e){return st.EmbedView(Qe((t,r)=>{if(t){let n=new St("New_1"),o=Ht(n.k,n.h,[]),a=new bt(o[1],ui(o[0]));return(n.i=a,a).Doc}else{let n=wl(o=>o.Id==e,r.Plans);return n==null?st.Empty:ci(n.$0)}},yr().View,Un().View))}function ci(e){let t,r=T.Create_1(1),n=_(b=>b.$==1?e.YearPrice:e.MonthPrice,mt().View),o=_(b=>b==null?"N/A":kn(b.$0.Amount),n),a=_(b=>(e.IsPerSeat?" / seat":"")+" / "+pr(b),mt().View),i=jn((b,p,y)=>p==null?"-":kn(p.$0.Amount*y),mt().View,n,r.View),l=_(b=>"Total ("+pr(b)+"ly)",mt().View),s=e.MaxSeats;if(s==null||s.$0>1){let b=T.Lens(r,String,(J,G)=>{let U,Z=(U=0,[bo(G,{get:()=>U,set:ut=>{U=ut}}),U]);return Z[0]?Z[1]:J}),p=new St("New_1"),y=(p.h.push(new wt("seatcount",b)),p),M=(y.h.push(tt(y.k,"onseatminus",()=>y.i,()=>{r.Get()>1&&r.Set(r.Get()-1)})),y),E=(M.h.push(tt(M.k,"onseatplus",()=>M.i,()=>{r.Set(r.Get()+1)})),M),D=Ht(E.k,E.h,[["seatcount",0,null]]),V=new bt(D[1],gi(D[0]));t=(E.i=V,V).Doc}else{let b=new St("New_1"),p=Ht(b.k,b.h,[]),y=new bt(p[1],wi(p[0]));t=(b.i=y,y).Doc}let d=at("href",Qe((b,p)=>"./checkout?plan="+String(e.Id)+"&interval="+String(pr(b))+"&seats="+String(ti(p)),mt().View,r.View)),u=new St("New_1"),m=(u.h.push(new ye("name",e.Name)),u),w=(m.h.push(new ye("description",e.Description)),m),f=(w.h.push(new At("priceamount",o)),w),k=(f.h.push(new At("pricelabel",a)),f),$=(k.h.push(new Zt("seatselector",t)),k),N=($.h.push(new At("totallabel",l)),$),C=(N.h.push(new At("totalamount",i)),N),v=(C.h.push(new B("checkoutattr",d)),C),c=Ht(v.k,v.h,[]),h=new bt(c[1],hi(c[0]));return(v.i=h,h).Doc}function g(e){return{$:1,$0:e}}var hr;var gr;function di(e){return e?Ae("support",g("content"),()=>pt(`\r
