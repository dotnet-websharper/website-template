...
export function Layout(){
  ...
  const t_5=(t_4.h.push(EventQ2(t_4.k, "closeonbackgroundclick", () => t_4.i, (_2) => {
    CloseOnBackgroundClick(_2);
  })),t_4);
  const t_6=(t_5.h.push(EventQ2(t_5.k, "accountbtnclick", () => t_5.i, (_2) => {
    AccountBtnClick(_2);
  })),t_5);
  ...
  const this_1=(t_8.h.push(EventQ2(t_8.k, "logout", () => t_8.i, (_2) => {
    Logout(_2);
  })),t_8);
    ...
    for(let i_1=0, _2=a.length-1;i_1<=_2;i_1++)((() => {
      ...
      if(!d.ContainsKey(n)){
        if(t===0){
          ...
          let _15=Some(_14);
          let _16=_c_3.Create_1(_15);
          _3=new VarDomElement(n, _16);
        }
        else if(t===6){
          const o_5=ov==null?null:Some(ov.$0);
          let _17=o_5==null?[]:o_5.$0;
          let _18=_c_3.Create_1(_17);
          _3=new VarStrList(n, _18);
        }
        else _3=FailWith("Invalid kind for template Var type: "+String(t));
...
function measureIndicatorPos(tab, container){
  let c;
  let c_1;
  return New_2((c=tab.getBoundingClientRect().left-container.getBoundingClientRect().left,String(c))+"px", (c_1=tab.getBoundingClientRect().width,String(c_1))+"px");
}
...
function copyContentAsync(textToCopy, copyIcon, okIcon, errIcon){
  return Delay(() => TryWith(Delay(() => Bind(AsAsync(navigator.clipboard.writeText(textToCopy)), () => {
    hide(copyIcon);
    show(okIcon);
...
function CompleteHoles(key, filledHoles, vars){
  ...
  return[append(filledHoles, choose((_3) => {
    ...
    if(filledVars.Contains(name))return null;
      ...
      }):ty===4?_c.GetOrAddHoleFor(key, name, () => new VarFile(name, _c_3.Create_1([]))):ty===5?_c.GetOrAddHoleFor(key, name, () => new VarDomElement(name, _c_3.Create_1(Some(globalThis.document.querySelector("[ws-dom="+name+"]"))))):ty===6?_c.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _4=o==null?[]:o.$0;
        let _5=_c_3.Create_1(_4);
...
let _c_1=Lazy((_i) => class $StartupCode_AccountMenu {
  ...
  static isOpen;
  static {
    this.isOpen=_c_3.Create_1(false);
    this.userV=UserView();
    this.isAuthedV=IsAuthedView();
    this.isLoading=_c_3.Create_1(true);
...
let _c_2=Lazy((_i) => class $StartupCode_SnippetCode {
  static {
    _c_2=_i(this);
  }
  static prism;
...
function Insert(elem, tree){
  ...
  let _2=New_3(elem, Flags(tree), arr, oar.length===0?null:Some((el) => {
    iter_1((f) => {
      f(el);
    }, oar);
  }));
...
function wrapMap(){
  return _c_11.wrapMap;
}
function defaultWrap(){
  return _c_11.defaultWrap;
}
function rxhtmlTag(){
  return _c_11.rxhtmlTag;
}
function rtagName(){
  return _c_11.rtagName;
}
...
function RenderedFullDocTemplate(){
  return _c_6.RenderedFullDocTemplate;
}
...
function ChildrenTemplate(el, fillWith){
  ...
  return!Equals(m, null)&&m.length===1&&(get(m, 0)instanceof Node&&(Equals(get(m, 0).nodeType, Node.ELEMENT_NODE)&&(_2=get(m, 0),true)))?Elt.TreeNode(docTreeNode, updates):Doc.Mk(TreeDoc(docTreeNode), updates);
}
function set_RenderedFullDocTemplate(_2){
  _c_6.RenderedFullDocTemplate=_2;
}
function LocalTemplatesLoaded(){
  return _c_6.LocalTemplatesLoaded;
}
function set_LocalTemplatesLoaded(_2){
  _c_6.LocalTemplatesLoaded=_2;
}
...
function InlineTemplate(el, fillWith){
  ...
  foreachNotPreserved(el, "[ws-attr-holes]", (e_1) => {
    ...
    for(let i=0, _9=holeAttrs.length-1;i<=_9;i++)((() => {
      ...
      re.lastIndex=0;
      const value=foldBack((_11, _12) =>(((t) => {
...
function New(IsCancellationRequested, Registrations){
...
let _c_4=Lazy((_i) => class $StartupCode_AuthClient {
  ...
  static {
    ...
    this.userVar=_c_3.Create_1(null);
    this.isFetchingVar=_c_3.Create_1(false);
...
class DocElemNode {
  ...
  static New(Attr_1, Children_1, Delimiters, El, ElKey, Render){
    ...
    return Create_1(DocElemNode, _3);
  }
}
...
function makeHeaders(headers){
  return NewFromSeq(map((_2) =>[_2[0], _2[1]], distinctBy((t) => t[0], headers.concat([["content-type", "application/json"]]))));
}
function EndPoint(){
...
let _c_7=Lazy((_i) => class Client {
  ...
  static {
    ...
    this.IntGetChecked=(el) => {
      ...
      let o;
      const s_8=el.value;
      if(isBlank(s_8))_2=(el.checkValidity?el.checkValidity():true)?CheckedInput.Blank(s_8):CheckedInput.Invalid(s_8);
      else {
...
function New_3(DynElem, DynFlags, DynNodes, OnAfterRender_1){
  ...
  SetOptional(_2, "OnAfterRender", OnAfterRender_1);
  return _2;
}
...
class Elt extends Doc {
  ...
  static TreeNode(tree, updates){
    ...
    let _2=TreeDoc(tree);
    const x=map((_5) => Updates(_5[1]), tree.Attrs);
    let _3=TreeReduce(Const(), Map2Unit, x);
    let _4=Map2Unit(_3, rvUpdates.v);
    return new Elt(_2, _4, get(tree.Els, 0), rvUpdates);
  }
    ...
    while(true)
      {
        if(doc!=null&&doc.$==1)return doc.$0.El;
          ...
          return foldBack((_4, _5) => _4==null||_4.constructor===Object?ins(_4, _5):_4, t.Els, pos);
        }
        else {
          const b=doc.$1;
          const a=doc.$0;
...
function BatchUpdatesEnabled(){
  return _c_9.BatchUpdatesEnabled;
}
...
let _c_11=Lazy((_i) => class $StartupCode_DomUtility {
  static {
    _c_11=_i(this);
  }
  static defaultWrap;
