...
function InitTabs(){
  ...
  for(let i=0, _1=toInt(snippets.length)-1;i<=_1;i++)initSnippetRoot(snippets[i]);
}
function prism(){
  return _c_2.prism;
}
...
function set_RenderedFullDocTemplate(_1){
  _c_6.RenderedFullDocTemplate=_1;
}
