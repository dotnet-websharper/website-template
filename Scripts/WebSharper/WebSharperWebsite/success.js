...
function DetailsDoc(){
  return _c_1.DetailsDoc;
}
function DetailsAttr(){
  return _c_1.DetailsAttr;
}
function MessageText(){
  return _c_1.MessageText;
}
...
let _c_1=Lazy((_i) => class $StartupCode_Success {
  static {
    _c_1=_i(this);
  }
  static DetailsDoc;
...
function ConfirmStripeOrder(_1){
  return Bind_1((new AjaxRemotingProvider()).Async("IRemotingContract/ConfirmStripeOrder", [_1]), (o) => Return((DecodeJson_FSharpResult_4())(o)));
}
...
function New_2(DynElem, DynFlags, DynNodes, OnAfterRender_2){
  const _1={
    DynElem:DynElem, 
    DynFlags:DynFlags, 
    DynNodes:DynNodes
