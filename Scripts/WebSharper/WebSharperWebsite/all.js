...
function EncodeJson_CheckoutPayload(){
  return Encoder_CheckoutPayload?Encoder_CheckoutPayload:Encoder_CheckoutPayload=(EncodeRecord(void 0, [["seats", Id_1(), 0], ["email", Id_1(), 0], ["interval", Id_1(), 0], ["planCode", Id_1(), 0], ["billingAddress", Id_1(), 0], ["company", Id_1(), 1]]))();
}
...
function CheckoutDoc(){
  ...
  const p=CompleteHoles(b.k, b.h, [["seatstext", 0, Some("1")], ["email", 0, null], ["street", 0, null], ["city", 0, null], ["postal", 0, null], ["country", 0, Some("")], ["iscompany", 2, null], ["companyname", 0, null], ["vatin", 0, null]]);
...
function startCheckout(payload){
  return Delay(() => {
    ...
    return TryWith(Delay(() => {
      let r;
      return Bind_1(AsAsync(globalThis.fetch("https://api.websharper.com/checkout/session", (r={},r.method="POST",r.credentials="include",r.headers=header(),r.body=JSON.stringify((EncodeJson_CheckoutPayload())(payload)),r))), (a) =>!a.ok?(checkoutError(),Return(null)):Bind_1(AsAsync(a.json()), (a_1) => Return(Some(a_1))));
    }), () => {
      checkoutError();
      return Return(null);
    });
