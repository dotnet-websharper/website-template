...
function buildPayload(){
  ...
  return New_15(form.plan.toLowerCase()=="freelancer"?"freelancer":"pro", intervalAsString(form.interval), form.plan.toLowerCase()=="freelancer"?1:seatsToSend, New_14(Trim(form.email), Trim(form.street), Trim(form.city), Trim(form.postal), form.country, form.isCompany?Some(Trim(form.companyName)):null, form.isCompany?Some(Trim(form.vatin)):null));
}
