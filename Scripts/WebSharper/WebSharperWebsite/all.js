...
function CheckoutDoc(){
  const T_1=BindSmoothLoader("w-14 h-6", "justify-end", Doc.TextView(Total()));
  const T_2=BindSmoothLoader("w-14 h-6", "justify-end", Doc.TextView(Taxes()));
  const S=BindSmoothLoader("w-14 h-6", "justify-end", Doc.TextView(Subtotal()));
  const P=BindSmoothLoader("w-64 h-4", "", Doc.TextView(PriceHint()));
  const P_1=BindSmoothLoader("w-12 h-5", "", Doc.TextView(PlanInterval()));
  const P_2=BindSmoothLoader("w-24 h-8", "", Doc.TextView(PlanPrice()));
  const P_3=BindSmoothLoader("w-64 h-6", "", Doc.TextView(PlanName()));
  const B=BindSmoothLoader("w-10 h-5", "", Doc.TextView(BackLinkLabel().View));
  ...
  const this_4=(this_3.h.push(new Attribute("authsectionattr", AuthSectionAttr())),this_3);
  const this_5=(this_4.h.push(new Attribute("paymentsectionattr", PaymentSectionAttr())),this_4);
  const this_6=(this_5.h.push(new Attribute("seatselectorattr", S_1)),this_5);
  const t_9=(this_6.h.push(new VarStr("seatstext", SeatsTextVar())),this_6);
  const t_10=(t_9.h.push(EventQ2(t_9.k, "onseatminus", () => t_9.i, () => {
    OnSeatMinus_1();
  })),t_9);
  const this_7=(t_10.h.push(EventQ2(t_10.k, "onseatplus", () => t_10.i, () => {
    OnSeatPlus_1();
  })),t_10);
  const this_8=(this_7.h.push(new VarStr("email", EmailVar())),this_7);
  const this_9=(this_8.h.push(new VarStr("street", StreetVar())),this_8);
  const this_10=(this_9.h.push(new VarStr("city", CityVar())),this_9);
  const this_11=(this_10.h.push(new VarStr("postal", PostalVar())),this_10);
  const this_12=(this_11.h.push(new VarStr("country", CountryVar())),this_11);
  const this_13=(this_12.h.push(new VarBool("iscompany", IsCompanyVar())),this_12);
  const this_14=(this_13.h.push(new Attribute("companyblockattr", C_3)),this_13);
  const this_15=(this_14.h.push(new VarStr("companyname", CompanyNameVar())),this_14);
  const this_16=(this_15.h.push(new Attribute("companynameattr", C_2)),this_15);
  const this_17=(this_16.h.push(new VarStr("vatin", VatinVar())),this_16);
  const this_18=(this_17.h.push(new Attribute("vatinattr", V)),this_17);
  const t_11=(this_18.h.push(new Elt("formerrordoc", FormErrorDoc())),this_18);
  const this_19=(t_11.h.push(EventQ2(t_11.k, "ongithublogin", () => t_11.i, () => {
    Login();
  })),t_11);
  const this_20=(this_19.h.push(new Attribute("continuebuttonattr", C_1)),this_19);
  const t_12=(this_20.h.push(new Elt("continuetext", C)),this_20);
  const this_21=(t_12.h.push(EventQ2(t_12.k, "oncontinueclick", () => t_12.i, () => {
    OnContinueClick();
  })),t_12);
  const this_22=(this_21.h.push(new Elt("backlinklabel", B)),this_21);
  const this_23=(this_22.h.push(new Elt("planname", P_3)),this_22);
  const this_24=(this_23.h.push(new Elt("planprice", P_2)),this_23);
  const this_25=(this_24.h.push(new Elt("planinterval", P_1)),this_24);
  const this_26=(this_25.h.push(new Elt("pricehint", P)),this_25);
  const this_27=(this_26.h.push(new Elt("subtotal", S)),this_26);
  const this_28=(this_27.h.push(new Elt("taxes", T_2)),this_27);
  const b=(this_28.h.push(new Elt("total", T_1)),this_28);
...
function BindSmoothLoader(widthHeightClass, justifyClass, actualContent){
  ...
  const this_1=new ProviderBuilder("New_1");
  const this_2=(this_1.h.push(new Text("wrapperclasses", widthHeightClass)),this_1);
...
function PlanPrice(){
  return _c_13.PlanPrice;
}
function PlanInterval(){
  return _c_13.PlanInterval;
}
function PriceHint(){
...
function AddSeatsButtonAttr(){
  return _c_14.AddSeatsButtonAttr;
}
function SeatsBody(){
  return _c_14.SeatsBody;
}
...
function BillingRecordVar(){
  return _c_15.BillingRecordVar;
}
function CompanyVatinVar(){
  return _c_15.CompanyVatinVar;
}
function CompanyNameVar_1(){
  return _c_15.CompanyNameVar;
}
function BillingCountryView(){
  return _c_15.BillingCountryView;
}
function BillingPostalView(){
  return _c_15.BillingPostalView;
}
function BillingCityView(){
  return _c_15.BillingCityView;
}
function BillingLine1View(){
  return _c_15.BillingLine1View;
}
function BillingVatinView(){
  return _c_15.BillingVatinView;
}
function BillingNameView(){
  return _c_15.BillingNameView;
}
function BtnBillingCancelAttr(){
  return _c_15.BtnBillingCancelAttr;
}
function BtnBillingSaveAttr(){
  return _c_15.BtnBillingSaveAttr;
}
function BtnBillingEditAttr(){
  return _c_15.BtnBillingEditAttr;
}
function BillingEditAttr(){
  return _c_15.BillingEditAttr;
}
function BillingViewAttr(){
  return _c_15.BillingViewAttr;
}
...
function CustomerPortalAttr(){
  return _c_16.CustomerPortalAttr;
}
...
let _c_11=Lazy((_i) => class $StartupCode_CheckoutState {
  ...
  static {
    ...
    this.CheckoutFormVar=_c_1.Create_1(New_12("pro", Year, "1", "", "", "", "", "HU", false, "", ""));
...
let _c_14=Lazy((_i) => class Seats_1 {
  static {
    _c_14=_i(this);
  }
  static SeatsBody;
...
let _c_15=Lazy((_i) => class Billing_1 {
  static {
    _c_15=_i(this);
  }
...
let _c_17=Lazy((_i) => class Invoices {
  static {
    _c_17=_i(this);
  }
  static InvoicesBody;
...
let _c_22=Lazy((_i) => class $StartupCode_Page {
  static {
    _c_22=_i(this);
  }
  static IsLoading;
