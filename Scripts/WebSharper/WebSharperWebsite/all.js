...
function CheckoutDoc(){
  ...
  const R=Doc.EmbedView(Map2((_3, _4) => {
    if(_3){
      ...
      const t_12=(this_28.h.push(new Elt("continuetext", C)),this_28);
...
function ManageSubscriptionDoc(){
  ...
  const C=Doc.EmbedView(Map2((_5, _6) => {
    if(_5){
      ...
      const t_13=(this_33.h.push(new Attribute("addseatsbuttonattr", AddSeatsButtonAttr())),this_33);
...
let _c_15=Lazy((_i) => class Pricing {
  ...
  static {
    ...
    this.CountryOptionsDoc=map_2((_2) => Doc.Element("option", [Attr.Create("value", _2[0])], [Doc.TextNode(_2[1])]), List());
  }
});
