...
export function Home(){
  ...
  const t_1=(this_1.h.push(new AfterRenderQ("onafterrender", "", () => {
    Init_1("ws-template");
    Init();
    Init_2();
  ...
  const t_2=(t_1.h.push(EventQ2(t_1.k, "copyfromclosest", () => t_1.i, (e) => {
    CopyFromClosest(e);
  })),t_1);
  const b=(t_2.h.push(EventQ2(t_2.k, "ontabclick", () => t_2.i, (e) => {
    OnTabClick(e.Event);
  })),t_2);
  const p=CompleteHoles(b.k, b.h, []);
  const i=new TemplateInstance(p[1], content_7(p[0]));
  let _2=(b.i=i,i);
  return _2.Doc;
}
...
export function Warp(){
  ...
  const p=CompleteHoles(b.k, b.h, []);
  const i=new TemplateInstance(p[1], content_5(p[0]));
  let _2=(b.i=i,i);
  return _2.Doc;
}
...
function FakeRootFromHTMLTemplate(parent){
  const fakeroot=globalThis.document.createElement("div");
  const content_6=parent.content;
  for(let i=0, _2=content_6.childNodes.length-1;i<=_2;i++)fakeroot.appendChild(content_6.childNodes[i].cloneNode(true));
  return fakeroot;
}
function TextHoleRE(){
...
function makeHeaders(headers){
  return NewFromSeq(map_1((_2) =>[_2[0], _2[1]], distinctBy_1((t_1) => t_1[0], headers.concat([["content-type", "application/json"]]))));
}
function EndPoint(){
