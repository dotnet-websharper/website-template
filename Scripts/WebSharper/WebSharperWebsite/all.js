...
function CheckoutDoc(){
  ...
  const R=Doc.EmbedView(Map2((_3, _4) => {
    if(_3){
      ...
      const t_11=new ProviderBuilder("New_1");
      const b_2=(t_11.h.push(EventQ2(t_11.k, "ongithublogin", () => t_11.i, () => {
        Login();
      })),t_11);
      ...
      const this_20=(this_19.h.push(new VarBool("iscompany", IsCompanyVar())),this_19);
      const this_21=(this_20.h.push(new Attribute("companyblockattr", C_3)),this_20);
      const this_22=(this_21.h.push(new VarStr("companyname", CompanyNameVar())),this_21);
      const this_23=(this_22.h.push(new Attribute("companynameattr", C_2)),this_22);
      const this_24=(this_23.h.push(new VarStr("vatin", VatinVar())),this_23);
      const this_25=(this_24.h.push(new Attribute("vatinattr", V)),this_24);
      const this_26=(this_25.h.push(new Elt("formerrordoc", FormErrorDoc())),this_25);
      ...
      const b_3=(t_12.h.push(EventQ2(t_12.k, "oncontinueclick", () => t_12.i, () => {
        OnContinueClick();
      })),t_12);
  ...
  const t_9=(this_5.h.push(new VarStr("seatstext", SeatsTextVar())),this_5);
  const t_10=(t_9.h.push(EventQ2(t_9.k, "onseatminus", () => t_9.i, () => {
    OnSeatMinus_1();
  })),t_9);
  const this_6=(t_10.h.push(EventQ2(t_10.k, "onseatplus", () => t_10.i, () => {
    OnSeatPlus_1();
  })),t_10);
...
function computeBackLink(){
  ...
  dest="/support#plans";
  label="Plans";
  if(!IsNullOrWhiteSpace(referrer))EndsWith(referrer, "/manage")?(dest="/manage",label="Manage subscription"):EndsWith(referrer, "/support")?(dest="/support#plans",label="Plans"):void 0;
...
function wrapMap(){
  return _c_25.wrapMap;
}
function defaultWrap(){
  return _c_25.defaultWrap;
}
function rxhtmlTag(){
  return _c_25.rxhtmlTag;
}
function rtagName(){
  return _c_25.rtagName;
}
...
let _c_8=Lazy((_i) => class $StartupCode_SupportState {
  ...
  static {
    ...
    this.catalogVar=_c_1.Create_1(New_9(fallbackPro(), fallbackFreelancer()));
...
let _c_10=Lazy((_i) => class $StartupCode_CheckoutState {
  ...
  static {
    ...
    this.ManageSubscriptionUrl="/manage";
    this.backLinkHref=_c_1.Create_1("/support#plans");
    this.BackLinkLabel=_c_1.Create_1("Plans");
    this.plansVar=_c_1.Create_1([]);
    this.CheckoutFormVar=_c_1.Create_1(New_11("pro", Year, "1", "", "", "", "", "HU", false, "", ""));
    this.SelectedPlanVar=_c_1.Lens(CheckoutFormVar(), (f) => f.plan, (_2, _3) => New_11(_3, _2.interval, _2.seatsText, _2.email, _2.street, _2.city, _2.postal, _2.country, _2.isCompany, _2.companyName, _2.vatin));
    this.SelectedIntervalVar=_c_1.Lens(CheckoutFormVar(), (f) => f.interval, (_2, _3) => New_11(_2.plan, _3, _2.seatsText, _2.email, _2.street, _2.city, _2.postal, _2.country, _2.isCompany, _2.companyName, _2.vatin));
    this.SeatsTextVar=_c_1.Lens(CheckoutFormVar(), (f) => f.seatsText, (_2, _3) => New_11(_2.plan, _2.interval, _3, _2.email, _2.street, _2.city, _2.postal, _2.country, _2.isCompany, _2.companyName, _2.vatin));
    this.EmailVar=_c_1.Lens(CheckoutFormVar(), (f) => f.email, (_2, _3) => New_11(_2.plan, _2.interval, _2.seatsText, _3, _2.street, _2.city, _2.postal, _2.country, _2.isCompany, _2.companyName, _2.vatin));
    this.StreetVar=_c_1.Lens(CheckoutFormVar(), (f) => f.street, (_2, _3) => New_11(_2.plan, _2.interval, _2.seatsText, _2.email, _3, _2.city, _2.postal, _2.country, _2.isCompany, _2.companyName, _2.vatin));
    this.CityVar=_c_1.Lens(CheckoutFormVar(), (f) => f.city, (_2, _3) => New_11(_2.plan, _2.interval, _2.seatsText, _2.email, _2.street, _3, _2.postal, _2.country, _2.isCompany, _2.companyName, _2.vatin));
    this.PostalVar=_c_1.Lens(CheckoutFormVar(), (f) => f.postal, (_2, _3) => New_11(_2.plan, _2.interval, _2.seatsText, _2.email, _2.street, _2.city, _3, _2.country, _2.isCompany, _2.companyName, _2.vatin));
    this.CountryVar=_c_1.Lens(CheckoutFormVar(), (f) => f.country, (_2, _3) => New_11(_2.plan, _2.interval, _2.seatsText, _2.email, _2.street, _2.city, _2.postal, _3, _2.isCompany, _2.companyName, _2.vatin));
    this.IsCompanyVar=_c_1.Lens(CheckoutFormVar(), (f) => f.isCompany, (_2, _3) => New_11(_2.plan, _2.interval, _2.seatsText, _2.email, _2.street, _2.city, _2.postal, _2.country, _3, _2.companyName, _2.vatin));
    this.CompanyNameVar=_c_1.Lens(CheckoutFormVar(), (f) => f.companyName, (_2, _3) => New_11(_2.plan, _2.interval, _2.seatsText, _2.email, _2.street, _2.city, _2.postal, _2.country, _2.isCompany, _3, _2.vatin));
    this.VatinVar=_c_1.Lens(CheckoutFormVar(), (f) => f.vatin, (_2, _3) => New_11(_2.plan, _2.interval, _2.seatsText, _2.email, _2.street, _2.city, _2.postal, _2.country, _2.isCompany, _2.companyName, _3));
...
let _c_24=Lazy((_i) => class Client {
  static {
    _c_24=_i(this);
  }
...
let _c_25=Lazy((_i) => class $StartupCode_DomUtility {
  static {
    _c_25=_i(this);
  }
  static defaultWrap;
...
function BatchUpdatesEnabled(){
  return _c_31.BatchUpdatesEnabled;
}
...
function StringSet(){
  return _c_24.StringSet;
}
function StringGet(){
  return _c_24.StringGet;
}
function StringListSet(){
  return _c_24.StringListSet;
}
function StringListGet(){
  return _c_24.StringListGet;
}
function DateTimeSetUnchecked(){
  return _c_24.DateTimeSetUnchecked;
}
function DateTimeGetUnchecked(){
  return _c_24.DateTimeGetUnchecked;
}
...
function FileSetUnchecked(){
  return _c_24.FileSetUnchecked;
}
function FileGetUnchecked(){
  return _c_24.FileGetUnchecked;
}
function IntSetUnchecked(){
  return _c_24.IntSetUnchecked;
}
function IntGetUnchecked(){
  return _c_24.IntGetUnchecked;
}
function IntSetChecked(){
  return _c_24.IntSetChecked;
}
function IntGetChecked(){
  return _c_24.IntGetChecked;
}
function FloatSetUnchecked(){
  return _c_24.FloatSetUnchecked;
}
function FloatGetUnchecked(){
  return _c_24.FloatGetUnchecked;
}
function FloatSetChecked(){
  return _c_24.FloatSetChecked;
}
function FloatGetChecked(){
  return _c_24.FloatGetChecked;
}
function StringApply(){
  return _c_24.StringApply;
}
function FloatApplyUnchecked(){
  return _c_24.FloatApplyUnchecked;
}
function BoolCheckedApply(){
  return _c_24.BoolCheckedApply;
}
function DateTimeApplyUnchecked(){
  return _c_24.DateTimeApplyUnchecked;
}
function FileApplyUnchecked(){
  return _c_24.FileApplyUnchecked;
}
function StringListApply(){
  return _c_24.StringListApply;
}
