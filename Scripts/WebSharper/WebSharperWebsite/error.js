...
export function Error_1(){
  ...
  const t=(this_3.h.push(new Elt("errormessage", E)),this_3);
  const t_1=(t.h.push(EventQ2(t.k, "onretry", () => t.i, () => {
    OnRetry();
  })),t);
  const b=(t_1.h.push(EventQ2(t_1.k, "onback", () => t_1.i, () => {
    OnBack();
  })),t_1);
...
function isAuthErrorVar(){
  return _c_1.isAuthErrorVar;
}
function getPrevious(searchParams){
  const _1=searchParams.get("from");
  const _2=searchParams.get("page");
  const _3=sameOriginReferer();
  return!IsNullOrWhiteSpace(_1)?_1:!IsNullOrWhiteSpace(_2)?_2:_3!=null&&_3.$==1?_3.$0:"/";
}
function previousVar(){
  return _c_1.previousVar;
}
function titleVar(){
  return _c_1.titleVar;
}
...
let _c_1=Lazy((_i) => class $StartupCode_Error {
  static {
    _c_1=_i(this);
  }
  static Message;
